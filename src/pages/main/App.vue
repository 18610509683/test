	...
	<div id="apps">
		...
		<div :class="['swiper-slide',!beforeLoaded?'loadingLeave':'']" :style="bgBoxStyle">
			<div id="loadingPage">
				...
				<img class="botImg" v-if="brand==2" src="/static/coverBg.png" />
				<div class="imgText">
					<!--<div class="title">COLMO智能冰箱年度使用报告</div>-->
					<!--<img class="together" src="@/images/colmo/together.png" />-->
				</div>
				<!--<img class="line" src="@/images/colmo/line.png" />-->
				<!--<div class="botBtnBox">
				<div class="btn">查看ta的报告</div>
